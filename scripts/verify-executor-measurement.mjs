...
const failures = [
  ...
  lifecycle?.heartbeatObservationCount >= 50 ? undefined : "Fewer than 50 Main heartbeat observations were recorded",
  lifecycle?.heartbeatP95DelayMs < 100 ? undefined : "Main heartbeat delay p95 exceeded 100ms",
